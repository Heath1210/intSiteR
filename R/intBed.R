...
#' @param theta a papameter controling the looseness of filter by duplicate degree
#' @param fThreshold the minimum duplicate degree allowed for further analysis.
#' @param monoSite the threshold that if the number of an integration site
#'     accompanied breaking points is above it, this site will be treated
#'     as monoclone and deduplicate not by breaking point.
#' @param collapse whether neighbouring sites collapsed to one.
